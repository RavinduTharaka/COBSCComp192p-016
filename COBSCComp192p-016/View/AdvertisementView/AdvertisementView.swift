...
//  COBSCComp192p-016
//
//  Created by Ravindu Tharaka Ranathunga on 2022-04-17.
//
            ...
            GeometryReader{_ in
                ScrollView{
                    LazyVStack{
                        ...
                        VStack(alignment: .leading){
                            ...
                            HStack(spacing: 15){
                                   Button {
                                       ...
                                       .background(
                                           RoundedRectangle(cornerRadius: 4)
                                            .stroke(self.advertisementVM.singleImage.images.isEmpty ? Color.black.opacity(0.7) : Color("Blue"), lineWidth: 2)
                                       )
                                   }
                        ...
                        VStack(alignment: .leading){
                            ...
                            HStack(spacing: 15){
                                ...
                                .background(
                                    RoundedRectangle(cornerRadius: 4)
                                        .stroke(self.advertisementVM.pickerAdvertisement.selected.isEmpty ? Color.black.opacity(0.7) : Color("Blue"), lineWidth: 2)
                                )
                        ...
                        TextField("Price", value: self.$advertisementVM.advertisement.price, formatter: advertisementVM.formatter)
                            ...
                            .background(
                                RoundedRectangle(cornerRadius: 4)
                                    .stroke(self.advertisementVM.advertisement.price != 0.0 ? Color("Blue") : Color.black.opacity(0.7), lineWidth: 2)
                            )
                            .padding(.top, 10)
                    ...
                    TextField("Land / House", text: self.$advertisementVM.advertisement.landORhouse)
                        ...
                        .background(
                            RoundedRectangle(cornerRadius: 4)
                                .stroke(self.advertisementVM.advertisement.landORhouse != "" ? Color("Blue") : Color.black.opacity(0.7), lineWidth: 2)
                        )
                        .padding(.top, 10)
                    ...
                    TextField("Land Size", value: self.$advertisementVM.advertisement.landSize, formatter: advertisementVM.formatter)
                        ...
                        .background(
                            RoundedRectangle(cornerRadius: 4)
                                .stroke(self.advertisementVM.advertisement.landSize != 0.0 ? Color("Blue") : Color.black.opacity(0.7), lineWidth: 2)
                        )
                        .padding(.top, 10)
                    ...
                    TextField("District", text: self.$advertisementVM.advertisement.district)
                        ...
                        .background(
                            RoundedRectangle(cornerRadius: 4)
                                .stroke(self.advertisementVM.advertisement.district != "" ? Color("Blue") : Color.black.opacity(0.7), lineWidth: 2)
                        )
                        .padding(.top, 10)
                    ...
                    TextField("Town/Village", text: self.$advertisementVM.advertisement.townVillage)
                        ...
                        .background(
                            RoundedRectangle(cornerRadius: 4)
                                .stroke(self.advertisementVM.advertisement.townVillage != "" ? Color("Blue") : Color.black.opacity(0.7), lineWidth: 2)
                        )
                        .padding(.top, 10)
